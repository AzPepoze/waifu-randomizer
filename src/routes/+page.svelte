...
<div id="main-content">
	...
	<div id="image-container" bind:this={imageContainer} style="height: {imageContainerHeight}" onclick={openModal}>
		{#if isLoading}
...
<style>
	...
	#loading-wrapper {
		position: absolute;
		display: none; /* Controlled by Svelte now but keeping style */
		flex-direction: column;
		align-items: center;
		gap: 20px;
